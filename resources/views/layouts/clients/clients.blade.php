...
@section('content')
    <div class="container-fluid">
        <a href="{{ route('create_client') }}" class="btn btn-secondary mb-1" type="button">Add Client</a>
{{--        <button class="btn btn-secondary mb-1" type="button" data-toggle="modal" data-target="#largeModal">Add Client</button>--}}
    </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Record new client</h4>
